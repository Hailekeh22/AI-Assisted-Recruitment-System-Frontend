...
export default function DashboardLayout({
  ...
  return (
    <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
      {/* Sidebar Navigation */}
      <div className="hidden h-screen sticky left-0 top-0 border-r bg-muted dark:bg-[#151515] md:block">
              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="flex items-center w-full gap-4 rounded-lg px-3 py-2 text-black dark:text-white transition-colors hover:bg-accent hover:text-primary"
                  >
      ...
      <div className="flex flex-col">
        <header className="flex h-14 sticky top-0 z-40 dark:bg-[#151515] items-center gap-4 border-b bg-muted px-4 lg:h-[60px] lg:px-6">
